...
public class TileManagement1 : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="x">X Koordinate des zu f�llenden Feldes</param>
    /// <param name="z">Y Koordinate des zu f�llenden Feldes</param>
    /// <returns></returns>
    PlacedTile findFittingTile(int x, int z)
    {
        ...
        {
            throw new MissingComponentException("ERROR! WIE ZUR H�LLE soll ich denn bitte ein Tile f�r die wanted verts\n" +
                wantedVerts[0] + "\n" + wantedVerts[1] + "\n" + wantedVerts[2] + "\n" + wantedVerts[3] + "\n finden??!" );
        }
    ...
    bool CheckWantedVerts(int[] verts, int[] wantedVerts)
    {
        ...
        {
            throw new ArgumentException("CheckWantedSides: wantedSides Argument muss die L�nge 4 haben.");
        }
...
class Tile
{
...

    {
        ...
        {
            throw new ArgumentOutOfRangeException("Ein Tile darf nicht mit dem Vertex 0 initialisiert werden. 0 ist f�r leere Kanten reserviert");
        }
